...
# Plot data and line
figS9a = scatter(x,y,c=:black)
        plot!(figS9a,[-2.0,6.0], m̂ * [-2.0,6.0] .+ ĉ, c="#ff375f")
...
for i = 1:n
    ...
    plot!(figS9a,[x[i],x[i]],[y[i],m̂ * x[i] + ĉ],ls=:dot,c="#007aff")
    plot!(figS9a,[x[i],x₂],[y[i],y₂],c="#007aff")
...
# Plot
figS9b = histogram(E,normalize=:pdf,lw=0.0,c = :Accent_3,label="Error")
...
figS9 = plot(figS9a,figS9b,size=(800,300))
#savefig("$(@__DIR__)/figS9.svg")